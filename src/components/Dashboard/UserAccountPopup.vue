<template>
  ...
  <div
    v-if="open"
    class="fixed z-50 bg_secondary_color shadow-sm profile_border bottom-[4.4em] w-64 lg:inset-auto lg:top-auto  popup_position lg:rounded-xl lg:w-52 px-2 py-4 "
    :class="[
