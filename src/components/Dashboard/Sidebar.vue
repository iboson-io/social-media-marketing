<template>
  ...
  >
    ...
    <div v-if="!isCollapsed" class="mb-6 mt-4">
      ...
      <div class="space-y-1">
        <div class="px-2 py-2 body_3_regular">Create new product</div>
        <div class="px-2 py-2 body_3_regular">Generate marketing plan</div>
        <div class="px-2 py-2 body_3_regular">Create Instagram post</div>
      </div>
    </div>
