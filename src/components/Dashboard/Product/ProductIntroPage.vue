<template>
    ...
    <!-- Card -->
    <div
      class="w-full  rounded-2xl bg_secondary_color px-6 h-[100%] shadow-sm flex items-center justify-center"
    >
      <div class="flex flex-col items-center text-center">
        ...
        <!-- Description -->
        <p class="mt-2 label_1_regular secondary_text_color">
        ...
        <button
          ...
          class="mt-5xl flex items-center gap-2  primary_button px-5 py-1"
        >
